...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: 'Instagram',
      href: 'https://instagram.com/bellafashion',
      icon: (
    ...
    {
      name: 'Facebook',
      href: 'https://facebook.com/bellafashion',
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/bellafashion',
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Pinterest',
      href: 'https://pinterest.com/bellafashion',
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Discover the latest trends in women's fashion. Quality clothing, fast shipping, and exceptional service.
            </p>
          ...
          {/* Account Links */}
          <div>
            <h4 className="font-semibold text-sm uppercase tracking-wider mb-4">Account</h4>
            <ul className="space-y-3">
          ...
          <div>
            ...
            <div className="mt-8">
              <h5 className="font-medium text-sm mb-2">Contact Us</h5>
              <div className="space-y-1 text-sm text-muted-foreground">
                <p>1-800-FASHION</p>
                <p>support@bellafashion.com</p>
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 text-sm text-muted-foreground">
            <p>&copy; {currentYear} Bella Fashion. All rights reserved.</p>
